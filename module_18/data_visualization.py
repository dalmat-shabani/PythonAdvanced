...
top_authors1=books_df['Author'].value_counts().head(15).reset_index()
top_authors1.column = ['Author', ' Count']

fig = px.bar(top_authors1, x="Author", y="count", orientation='h', title='Top 15 Authors by Counts of Books 2009-2022', labels={'Count': 'Count of Books Published', 'Author': 'Anthoe' }, color='count', color_continuous_scale=px.colors.sequential.Plasma)
st.plotly_chart(fig)
